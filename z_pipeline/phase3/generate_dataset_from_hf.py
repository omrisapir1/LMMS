...
if __name__ == '__main__':
    generate_phase3_dataset_from_hf(phase2_repo_id=Phase2Config.hf_repo, phase3_dataset_repo_id="omrisap/phase3_train_dataset_hard_max", dataset_name=Phase2Config.data.dataset_name, batch_size=64, device="cuda", temperature=0.0,z_mode='hard_argmax')